...
- [ ] T029 packages/design-tokens — direct copy tokens from ~/Documents/projects/no-vain-years/no-vain-years-app/packages/design-tokens/ (NO redesign, per memory)
...
- [ ] T034 AuthGate decision update — 3rd state target /(app)/(tabs)/profile (FR-014)
  <!-- task-meta: {"id":"T034","workspace":"mobile-app","deps":["T033"],"trace_us":["US5","US6","US12"],"trace_fr":["FR-014","FR-016"],"kind":"impl","verify_kind":"typecheck","files":[{"path":"apps/mobile/app/_layout.tsx","op":"modify"},{"path":"apps/mobile/lib/auth-gate-decision.ts","op":"create"}],"parallel":false} -->
...
- [ ] T040 Playwright e2e — GetProfile + UpdateDisplayName flow (Web target) + auto screenshots via page.screenshot()
  <!-- task-meta: {"id":"T040","workspace":"mobile-app","deps":["T022","T023","T035","T036","T037","T039"],"trace_us":["US5","US6","US7","US8","US9","US10","US11","US12"],"trace_fr":["FR-016","FR-017","FR-018","FR-024"],"trace_sc":["SC-008","SC-009","SC-013","SC-016","SC-017"],"kind":"test-e2e","verify_kind":"e2e","files":[{"path":"apps/mobile/e2e/profile.spec.ts","op":"create"}],"parallel":false} -->
