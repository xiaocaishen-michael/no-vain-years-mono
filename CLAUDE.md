...
| Plan 2 业务迁移 / Plan 3 部署上线 / Phase 0 prep / per-feature SDD gate | [Plan 2/3](docs/plans/plan2-plan3-clever-sutherland.md)（2026-05-19 ship；16 use case 顺序迁移 + 部署形态待 ADR-0026） |
