...
阶段性节点(Plan 1/2/3 / M0-M4)走 **GitHub Milestones**(用于 issue / PR 归类)+ `docs/plans/YYYY-MM/MM-DD-<slug>.md` 文档(git log 自然带 SHA);组件化 tag `server-vX.Y.Z` / `mobile-vX.Y.Z` 由 release-please 自动打。
